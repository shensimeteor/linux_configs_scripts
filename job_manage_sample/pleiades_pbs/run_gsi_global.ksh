...
#  GUESS_TIME=2014080318
  GFSCASE=T254
  ROOT_GSICODE=/home1/sshen3/nobackup/save/comGSI/comGSIv3.6_EnKFv1.2/
  WORK_ROOT=GFS_${ANAL_TIME}
  DATA_ROOT=${ROOT_GSICODE}/../tutorial_data/T254.2014070706/
  BK_ROOT=${DATA_ROOT}/bk
  OBS_ROOT=${DATA_ROOT}/obs
  PREPBUFR=${OBS_ROOT}/prepbufr
  CRTM_ROOT=${ROOT_GSICODE}/../CRTM_2.2.3/
  GSI_ROOT=${ROOT_GSICODE}
